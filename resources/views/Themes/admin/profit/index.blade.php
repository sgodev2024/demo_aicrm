            ...
            function updateTable(list) {
                ...
                var newRow = `
                    <tr>
                        ...
                        <td>${item.product.price * item.quantity - item.product.priceBuy * item.quantity}</td>
                        <td>${(100 * (item.product.price * item.quantity - item.product.priceBuy * item.quantity) / (item.product.priceBuy * item.quantity)).toFixed(2)}%</td>
                    </tr>`;
