                            ...
                            <div class="row">
                                <div class="col-12">
                                    <div class="d-flex justify-content-between align-items-center">
                                        ...
                                        <form action="{{ route('admin.staff.store') }}" method="GET" class="d-flex"
                                            role="search">
                                            ...
                                            <a class="btn btn-outline-danger mx-2" href="{{ route('admin.staff.store') }}">  <i class="fas fa-sync-alt"></i></a>
                                        </form>

                                        <!-- Nút Thêm mới -->
                                        <a class="btn btn-primary" href="{{ route('admin.staff.addForm') }}">Thêm mới</a>
                                    </div>
                                </div>
                            </div>
